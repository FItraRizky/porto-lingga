    ...
    return createPortal(
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel fixed top-0 right-0 h-screen bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-[9999] backdrop-blur-[12px]"
